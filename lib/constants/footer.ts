import { LinkGroup } from "../types/footer";

export const OFFICE_DETAILS = {
  address: "Vibrant House 16 Canal Road, Palagathura, Kochchikade, Negombo, Sri Lanka 11500.",
  email: "info@lankalagoontours.lk",
  phone: "+94 76 344 3826",
};
...
export const LINK_GROUPS: LinkGroup[] = [
  {
    heading: "Our Tours",
    links: [
      { label: "Sunset Lagoon Tour", href: "/tours/sunset-lagoon" },
      { label: "Mangrove Explorer", href: "/tours/mangrove-explorer" },
      { label: "Full-Day Charter", href: "/tours/full-day-charter" },
    ],
  },
  {
    heading: "Quick Links",
