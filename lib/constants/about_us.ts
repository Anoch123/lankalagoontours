...
export const CERT_POINTS = [
  "Boats and facilities meet national standards for safety and sustainability",
  "Fully covered by public liability insurance for your peace of mind",
  "Complete safety gear carried on every boat",
  "Crew trained in boat operations, lifeguarding, and eco-tourism guiding",
  "Committed to a safe, professional, and low-impact experience on the water",
];
