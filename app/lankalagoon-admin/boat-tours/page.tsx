...
import { BoatTourForm, ItineraryStop } from '@/lib/types/api/admin'
...
export default function AdminBoatTours() {
    const [tour, setTour] = useState<BoatTourForm>(emptyTour)
    ...
    const buildPayload = () => ({
        ...
        groupMin: Number(tour.groupMin) || 0,
        groupMax: Number(tour.groupMax) || 0,
        ...
        <AdminLayout>
            <form onSubmit={handleSubmit} className="space-y-8 max-w-4xl">
                ...
                <Section title="Logistics">
                    ...
                    <Field label="Group min">
                        <input
                            ...
                            className={inputClass}
                            value={tour.groupMin}
                            onChange={(e) => update('groupMin', e.target.value)}
                            placeholder="2"
                        />
                    </Field>
                    ...
                    <Field label="Group max">
                        <input
                            ...
                            className={inputClass}
                            value={tour.groupMax}
                            onChange={(e) => update('groupMax', e.target.value)}
                            placeholder="12"
                        />
                    </Field>
                ...
                <div className="flex items-center gap-4 pt-2 pb-10">
                    ...
                    {saved && (
                        <span className="text-sm text-[#588157]">Saved — check the console for the payload.</span>
                    )}
                </div>
            </form>
        </AdminLayout>
