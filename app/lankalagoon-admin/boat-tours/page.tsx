        ...
        <AdminLayout>
            <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <a href='/lankalagoon-admin/boat-tours/create' className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors">
                        + Add Tour
                    </a>
                </div>
                            ...
                            {tours.map((tour) => (
                                <tr key={tour.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-3">
                                        <a href={`/lankalagoon-admin/boat-tours/${tour.id}`} className="text-blue-600 hover:text-blue-800">
                                            Edit
                                        </a>
                                    </td>
                                </tr>
